        ...
        if ($laundry->isDirty('status')) {
            ...
            switch ($newStatus) {
                case 'ready':
                    ...
                    // Customer: DB + FCM via NotificationService (single call, no duplicate)
                    if ($laundry->customer_id) {
                        NotificationService::sendToCustomer(
                            $laundry->customer_id,
                            'laundry_ready',
                            '✅ Laundry Ready!',
                            "Your laundry #{$laundry->tracking_number} is clean and ready for pickup!",
                            $laundry->id,
                            null,
                            ['type' => 'laundry_ready', 'laundry_id' => (string) $laundry->id, 'laundries_id' => (string) $laundry->id]
                        );
                    }
                    break;
                ...
                case 'completed':
                    ...
                    if ($laundry->customer_id) {
                        NotificationService::sendToCustomer(
                            ...
                            'laundry_completed',
                            '🎉 Order Completed!',
                            "Your laundry order #{$laundry->tracking_number} has been completed. Thank you for choosing WashBox!",
                            $laundry->id,
                            null,
                            ['type' => 'laundry_completed', 'laundry_id' => (string) $laundry->id, 'laundries_id' => (string) $laundry->id]
                        );
                    }
                    break;
                ...
                case 'cancelled':
                    ...
                    if ($laundry->customer_id) {
                        NotificationService::sendToCustomer(
                            ...
                            'laundry_cancelled',
                            'Laundry Cancelled',
                            "Your laundry order #{$laundry->tracking_number} has been cancelled.",
                            $laundry->id,
                            null,
                            ['type' => 'laundry_cancelled', 'laundry_id' => (string) $laundry->id, 'laundries_id' => (string) $laundry->id]
                        );
                    }
                    break;
            }
