...
class ReportController extends Controller
{
    ...
    public function daily(Request $request)
    {
        try {
            ...
            return view('branch.reports.daily', compact('laundries', 'summary', 'date'));
    ...
    public function weekly(Request $request)
    {
        try {
            ...
            return view('branch.reports.weekly', compact('laundries', 'dailyBreakdown', 'startDate', 'endDate'));
    ...
    public function monthly(Request $request)
    {
        try {
            ...
            return view('branch.reports.monthly', compact('laundries', 'month', 'year'));
