...
<div class="pk-page">
    ...
    <div class="d-flex gap-2 mb-3">
        <a href="{{ route('admin.pickups.index', array_merge(request()->except('tab','page'), ['tab'=>'active'])) }}"
        ...
        <a href="{{ route('admin.pickups.index', array_merge(request()->except('tab','page'), ['tab'=>'laundry'])) }}"
                    ...
                    <div class="card-body p-3" style="background-color: var(--card-bg) !important; color: var(--text-primary) !important;">
                        ...
                        <div class="d-flex gap-2 mt-3">
                            ...
                            @if($tab === 'laundry' && $hasLaundry)
                                <a href="{{ route('admin.laundries.show', $pickup->laundry->id) }}" class="btn btn-sm btn-success flex-fill">
                                    <i class="bi bi-basket"></i> View Laundry
                                </a>
                            @elseif($pickup->status === 'picked_up' && !$hasLaundry)
