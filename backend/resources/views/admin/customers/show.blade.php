...
@section('content')
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="row g-4 mb-4">
                <div class="col-sm-4">
                    <div class="metric-card">
                        <div class="metric-icon avg-laundry-value">
                            <i class="bi bi-calculator-fill"></i>
                        </div>
                        <div class="metric-details">
                            <span class="metric-label">Avg Laundry Value</span>
                            <span class="metric-value">₱{{ $customer->getTotalLaundriesCount() > 0 ? number_format($customer->getTotalSpent() / $customer->getTotalLaundriesCount(), 0) : '0' }}</span>
            ...
            {{-- Recent Laundries Section with Enhanced Empty State --}}
            <div class="laundries-section-card">
                <div class="card-header-modern d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="mb-0 fw-700">Recent Laundries</h5>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form method="POST" action="{{ route('admin.customers.export-orders') }}" class="d-inline">
                            @csrf
                    ...
                    @else
                        ...
                        <div class="empty-state-enhanced">
                            ...
                            <div class="empty-state-actions">
                                <a href="{{ route('admin.laundries.create', ['customer_id' => $customer->id]) }}" class="btn btn-modern btn-primary rounded-pill">
