...
@section('page-title', 'CREATE SERVICE TYPE')

@section('content')
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <p class="text-muted small mb-0">Add a new service type template</p>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-select @error('category') is-invalid @enderror" required>
                                ...
                                <option value="drop_off" {{ old('category') == 'drop_off' ? 'selected' : '' }}>🛍 Drop Off</option>
                                <option value="self_service" {{ old('category') == 'self_service' ? 'selected' : '' }}>🧺 Self Service</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                   value="{{ old('icon', 'bi-box-seam') }}" placeholder="bi-box-seam">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="defaults[pricing_type]" class="form-select @error('defaults.pricing_type') is-invalid @enderror">
                                <option value="per_load" {{ old('defaults.pricing_type') == 'per_load' ? 'selected' : '' }}>Per Load</option>
                                <option value="per_piece" {{ old('defaults.pricing_type') == 'per_piece' ? 'selected' : '' }}>Per Piece</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="defaults[max_weight]" step="0.1" min="0"
                                   ...
                                   value="{{ old('defaults.max_weight') }}" placeholder="Leave blank for no limit">
                        ...
                        <div class="mb-0">
                            ...
                            <input type="number" name="defaults[turnaround]" min="0"
                                   ...
                                   value="{{ old('defaults.turnaround', 24) }}">
