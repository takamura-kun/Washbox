...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            <a href="{{ route('branch.laundries.show', $paymentProof->laundry) }}" class="btn btn-info">
                <i class="bi bi-box-seam me-1"></i>
                View Laundry
            </a>
            <a href="{{ route('branch.payments.verification.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-6">
            ...
            <div class="card border-0 shadow-sm mt-4">
                <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('branch.laundries.show', $paymentProof->laundry) }}" class="btn btn-sm btn-outline-info">
...
<div class="modal fade" id="approveModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('branch.payments.verification.approve', $paymentProof) }}">
                @csrf
                <div class="modal-header">
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('branch.payments.verification.reject', $paymentProof) }}">
                @csrf
                <div class="modal-header">
