        ...
        <div class="card-body">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card border-warning h-100">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('branch.pickups.accept', $pickup->id) }}" method="POST" class="d-inline">
                                        @csrf
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('branch.pickups.show', $pickup->id) }}"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('branch.pickups.index') }}" class="btn btn-outline-primary mt-2">
                            ...
                            @foreach($confirmedPickups->where('assigned_to', auth()->id()) as $pickup)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @if($pickup->status == 'accepted')
                                                <form action="{{ route('branch.pickups.en-route', $pickup->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                            ...
                                            @elseif($pickup->status == 'en_route')
                                                <form action="{{ route('branch.pickups.picked-up', $pickup->id) }}" method="POST" class="d-inline">
                                                    @csrf
