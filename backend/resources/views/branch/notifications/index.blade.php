...
<div class="notif-page">
    ...
    <div class="notif-header">
        ...
        <div class="notif-actions">
            @if($counts['unread'] > 0)
                <form action="{{ route('branch.notifications.mark-all-read') }}" method="POST">
                    @csrf
            ...
            @endif
            @if($counts['read'] > 0)
                <form action="{{ route('branch.notifications.delete-read') }}" method="POST"
    ...
    <div class="notif-filter-card">
        ...
        <div class="notif-filter-pills">
            ...
            <a href="{{ route('branch.notifications.index', ['status' => 'unread']) }}"
            ...
            <a href="{{ route('branch.notifications.index', ['status' => 'read']) }}"
        ...
        @if($types->count() > 0)
            <select class="notif-type-select" onchange="window.location.href=this.value">
                <option value="{{ route('branch.notifications.index', request()->except('type')) }}">All Types</option>
                @foreach($types as $type)
                    <option value="{{ route('branch.notifications.index', array_merge(request()->all(), ['type' => $type])) }}"
                    ...
                    <div class="notif-content-top">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu notif-dropdown-menu dropdown-menu-end">
                                @if(!$notification->is_read)
                                    <li>
                                        <form action="{{ route('branch.notifications.mark-read', $notification->id) }}" method="POST">
                                            @csrf
                                ...
                                <li>
                                    <form action="{{ route('branch.notifications.destroy', $notification->id) }}" method="POST"
