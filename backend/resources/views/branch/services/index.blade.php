...
.services-page .col-xl-3,
.services-page .col-md-6 {
    background: transparent;
}

/* Stats card specific styling */
.services-page .card.border-0.shadow-sm {
    background: var(--card-bg);
    color: var(--text-primary);
}
...
.services-page .card .text-muted {
    color: var(--text-secondary) !important;
}

/* Icon backgrounds */
.services-page .bg-primary.bg-opacity-10,
.services-page .bg-success.bg-opacity-10,
.services-page .bg-info.bg-opacity-10,
.services-page .bg-warning.bg-opacity-10 {
...
@section('content')
<div class="container-fluid px-4 py-4 services-page" style="background: var(--bg-color);">
    {{-- Header --}}
    <div class="d-flex justify-content-between align-items-center mb-4" style="background: transparent;">
        <div>
          
            <p class="text-muted small mb-0" style="color: var(--text-secondary);">View all available laundry service packages</p>
        </div>
    ...
    {{-- Stats Cards --}}
    <div class="row g-3 mb-4" style="background: transparent;">
    ...
    <div class="card border-0 shadow-sm" style="background: var(--card-bg);">
        <div class="card-header border-bottom" style="background: var(--bg-color);">
        ...
        <div class="card-body p-0" style="background: var(--card-bg);">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="servicesTable" style="background: var(--card-bg);">
                    <thead class="table-light" style="background: var(--bg-color);">
                        <tr>
                            <th class="ps-4">
                    ...
                    <tbody>
                        ...
                        <tr class="service-row" data-active="{{ $service->is_active ? '1' : '0' }}" data-id="{{ $service->id }}">
                            ...
                            <td class="text-end pe-4">
                                <a href="{{ route('branch.services.show', $service) }}" class="btn btn-sm btn-outline-info" title="View Details">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
            ...
            @else
            <div class="text-center py-5" style="background: var(--card-bg);">
                <div class="py-4">
                    <i class="bi bi-droplet display-1 text-muted opacity-25"></i>
                    <h5 class="text-muted mb-2 mt-3" style="color: var(--text-secondary);">No services available</h5>
                    <p class="text-muted mb-0" style="color: var(--text-secondary);">Services will appear here once created by admin.</p>
                </div>
            </div>
            @endif
        </div>
