                ...
                <div class="card-body text-white p-5 position-relative">
                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex align-items-center gap-3" style="font-size: 1rem;">
                                @if($user->branch)
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-geo-alt-fill me-2"></i>
                                        <span>{{ $user->branch->name }} Branch</span>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-people-fill me-2"></i>
                                        <span>{{ $staffCount ?? 0 }} Staff Members</span>
                                    </div>
                                @endif
                            </div>
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card profile-card h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('branch.profile') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group profile-input-group">
                                ...
                                <input type="text" name="phone" class="form-control profile-input @error('phone') is-invalid @enderror"
        ...
        <div class="col-lg-4 mb-4">
            <div class="card profile-card h-100">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('branch.profile.password') }}" method="POST">
                        @csrf
