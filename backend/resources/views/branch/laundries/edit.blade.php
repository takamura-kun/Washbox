...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('branch.laundries.show', $laundry) }}" class="btn btn-outline-info">
                <i class="bi bi-eye me-1"></i>View
            </a>
            <a href="{{ route('branch.laundries.index') }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('branch.laundries.update', $laundry) }}" method="POST" id="laundryForm">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            {{-- Weight --}}
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" for="weightInput" id="weightLabel">
                            ...
                            {{-- Loads / Pieces --}}
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" for="loadsInput" id="loadsLabel">
                ...
                <div class="d-flex gap-2 mb-4">
                    ...
                    <a href="{{ route('branch.laundries.show', $laundry) }}"
                            ...
                            <div class="small text-muted">
                                ...
                                @if($laundry->pickupRequest)
                                    <div class="mb-0">
                                        ...
                                        <a href="{{ route('branch.pickups.show', $laundry->pickup_request_id) }}">
