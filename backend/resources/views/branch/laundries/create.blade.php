...
<div class="container-fluid px-3 py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2 page-header">
        ...
        <a href="{{ isset($pickup) ? route('branch.pickups.show', $pickup) : route('branch.laundries.index') }}"
            ...
            <div class="d-flex align-items-start">
                ...
                <div style="flex: 1;">
                    ...
                    <p class="mb-0 small">
                        ...
                        @else
                            Please reduce the weight or split the laundry into multiple loads.
                        @endif
                    </p>
                </div>
                ...
                <div class="card border-0 shadow-sm rounded-3 mb-2">
                    ...
                    <div class="card-body p-3">
                        <div class="row g-2">
                            ...
                            {{-- Service --}}
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" for="serviceSelect">Service <span class="text-danger">*</span></label>
                                @if(isset($pickup) && $pickup->service_id)
                                    ...
                                    <input type="hidden" name="service_id" value="{{ $pickup->service_id }}"
                                        ...
                                        data-allow-excess-weight="{{ ($pickup->service->allow_excess_weight ?? false) ? '1' : '0' }}"
                                        data-excess-weight-charge="{{ $pickup->service->excess_weight_charge_per_kg ?? 0 }}">
                                    ...
                                    @if($dropOff->count())
                                        ...
                                        @foreach($dropOff as $service)
                                            ...
                                            <option value="{{ $service->id }}"
                                                    ...
                                                    data-allow-excess-weight="{{ $service->allow_excess_weight ? '1' : '0' }}"
                                                    data-excess-weight-charge="{{ $service->excess_weight_charge_per_kg ?? 0 }}"
                                    ...
                                    @if($selfService->count())
                                        ...
                                        @foreach($selfService as $service)
                                            ...
                                            <option value="{{ $service->id }}"
                                                    ...
                                                    data-min-weight=""
                                                    data-max-weight=""
                                                    data-allow-excess-weight="0"
                                                    data-excess-weight-charge="0"
                                                    data-turnaround-time="{{ $service->turnaround_time }}">  
                                                {{ $service->name }}
                            ...
                            <div class="col-md-6" id="weightContainer">
                                <label class="form-label fw-semibold" for="weightInput">Weight (kg) <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm rounded-4 h-100 @if(isset($pickup)) border-warning border-2 @endif">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="row g-2">
                                    <div class="col-12">
                                        <label class="form-label fw-semibold small" for="pickupFeeInput">
                                    ...
                                    <div class="col-12">
                                        <label class="form-label fw-semibold small" for="deliveryFeeInput">
