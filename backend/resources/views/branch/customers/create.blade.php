    ...
    <div class="container-fluid px-4 register-customer-page">
        <div class="page-header">
            <div class="d-flex align-items-center gap-3 mb-3">
                <a href="{{ route('branch.customers.index') }}" class="back-button">
            ...
            <div class="col-lg-9 col-xl-8">
                <div class="register-card">
                    ...
                    <div class="card-body-custom">
                        <form action="{{ route('branch.customers.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-group-custom">
                                        ...
                                        <select name="preferred_branch_id" class="form-control-custom form-select-custom @error('preferred_branch_id') is-invalid @enderror">
                                ...
                                <div class="col-12">
                                    <div class="form-group-custom">
                                        ...
                                        <textarea name="address" 
                                                  ...
                                                  style="resize: vertical; min-height: 90px;">{{ old('address') }}</textarea>
                                        @error('address')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                        <div class="form-hint">
                            ...
                            <div class="action-footer">
                                <a href="{{ route('branch.customers.index') }}" class="btn-custom btn-cancel">
