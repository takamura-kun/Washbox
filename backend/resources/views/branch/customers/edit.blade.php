...
<div class="container-fluid px-4 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold mb-0">Edit Customer Profile</h2>
        <div class="d-flex gap-2">
            <a href="{{ route('branch.customers.show', $customer->id) }}" class="btn btn-outline-primary">
                <i class="bi bi-eye me-1"></i> View Profile
            </a>
            <a href="{{ route('branch.customers.index') }}" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-left me-1"></i> Back
            </a>
        </div>
    </div>

    <form action="{{ route('branch.customers.update', $customer->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row g-4">
                    ...
                    <div class="card-body p-4" style="background-color: var(--card-bg) !important; color: var(--text-primary) !important;">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="preferred_branch_id" value="{{ $currentBranch->id }}">
                                <small class="text-muted">Staff can only manage customers from their branch.</small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card border-0 shadow-sm rounded-4" style="background-color: var(--card-bg) !important; color: var(--text-primary) !important;">
                    <div class="card-body p-4" style="background-color: var(--card-bg) !important; color: var(--text-primary) !important;">
                        <h6 class="fw-bold mb-2 small text-uppercase" style="color: var(--text-primary) !important;">Staff Note</h6>
