                ...
                <div class="card border-0 shadow-sm rounded-4 h-100 customer-card">
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex gap-2 mt-3">
                            <a href="{{ route('staff.customers.show', $customer) }}" class="btn btn-sm btn-outline-primary flex-fill">
                                <i class="bi bi-eye"></i> View
                            </a>
                            <a href="{{ route('staff.customers.edit', $customer) }}" class="btn btn-sm btn-outline-secondary flex-fill">
