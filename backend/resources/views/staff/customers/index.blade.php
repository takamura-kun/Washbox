...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 page-header">
        ...
        <a href="{{ route('staff.customers.create') }}" class="btn btn-primary shadow-sm px-4">
        ...
        @if(request()->anyFilled(['search', 'branch_id', 'status', 'registration_type']))
            <div class="mt-3 pt-3 border-top">
                <div class="d-flex align-items-center gap-2 flex-wrap">
                    ...
                    @endif
                    <a href="{{ route('staff.customers.index') }}" class="btn btn-sm btn-link text-danger p-0 ms-2">
                        Clear all
                    </a>
                </div>
            </div>
    ...
    <div class="table-card">
        <div class="table-header">
            <h6>
                <i class="bi bi-people"></i> Customers List - {{ $currentBranch->name }}
            </h6>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <div class="action-buttons">
                                <a href="{{ route('staff.customers.show', $customer) }}" class="action-btn view" title="View Details">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="{{ route('staff.customers.edit', $customer) }}" class="action-btn edit" title="Edit Customer">
                    ...
                    <tr>
                        <td colspan="7" class="p-0">
                            <div class="empty-state">
                                ...
                                @if(request()->anyFilled(['search', 'branch_id', 'status', 'registration_type']))
                                    <a href="{{ route('staff.customers.index') }}" class="btn btn-outline-primary">
