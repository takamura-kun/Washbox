...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('staff.unclaimed.export') }}" class="btn btn-outline-success btn-sm shadow-sm">
                        ...
                        <tbody>
                            @forelse($laundries as $laundry)
                                ...
                                <tr class="{{ $urgency === 'critical' ? 'row-critical' : ($urgency === 'urgent' ? 'row-warning-row' : '') }}">
                                    ...
                                    <td>
                                        <a href="{{ route('staff.unclaimed.show', $laundry) }}" class="fw-semibold" style="color: var(--primary-color); text-decoration: none;">
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="action-btn-group">
                                            ...
                                            <form action="{{ route('staff.unclaimed.mark-disposed', $laundry->id) }}"
                                                  method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit"
